                ...
                <div class="run-customer">
                  ...
                  <form action="{{ route('user.register') }}" method="POST" id="form__js">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" value="{{ old('email') }}" id="email" name="email" aria-describedby="emailHelp" placeholder="Nhập email" required>
                      @if ($errors->get('email'))
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control form-select" id="city" name="city">
                        ...
                        <option value="{{ $city['ProvinceID'] }}"
                          ...
                          selected
                          @endif>{{ $city['NameExtension'][1] }}</option>
                        @endforeach
                      </select>
                      @if ($errors->get('city'))
