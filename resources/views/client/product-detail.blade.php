                ...
                <div class="product-thumb">
                  <div class="image product-imageblock">
                    <a href="{{ route('user.products_detail', $relatedProduct->id) }}">
                      <img loading="lazy" style="height: 450px; object-fit: contain;" data-name="product_image" src="{{ asset("asset/client/images/products/small/$relatedProduct->img") }}" alt="iPod Classic" title="iPod Classic" class="img-responsive">
                      <img loading="lazy" style="height: 450px; object-fit: contain;" src="{{ asset("asset/client/images/products/small/$relatedProduct->img") }}" alt="iPod Classic" title="iPod Classic" class="img-responsive">
                    </a>
                  </div>
